...
def predict_single_sample(N, P, K, temperature, humidity, ph, rainfall, model_path, scaler_path):
    """
...
def batch_predict(input_file, output_file, model_path, scaler_path):
    ...
    # Make predictions
    results = predict_crop(input_data, model_path, scaler_path)
...
def main(input_file=None, output_file=None):
    ...
    if input_file and output_file:
        # Batch prediction
        results = batch_predict(input_file, output_file, model_path, scaler_path)
    else:
